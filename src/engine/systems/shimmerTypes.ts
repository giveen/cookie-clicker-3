		...
		export const shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(this: any, me: any)
				{
					...
					if (Game.Has('Cosmic jam jars')) dur*=1.04;//CC3: Heavenly Pantry
				...
				popFunc:function(this: any, me: any)
				{
					...
					if (Game.Has('Tinned peaches')) effectDurMod*=1.04;//CC3: Heavenly Pantry
					if (Game.Has('Comet cotton candy')) effectDurMod*=1.06;
				...
				getTimeMod:function(this: any, me: any, m: any)
				{
					...
					if (Game.Has('Jars of preserved starlight')) m*=0.97;//CC3: Heavenly Pantry
					if (Game.Has('Thousand-year egg')) m*=0.95;
