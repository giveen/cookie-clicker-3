...
export function declareVanillaBuildings(Game: EngineGame) {
	...
	const KEEP_OWN_DRAW: Record<string, boolean>={Grandma:true,Cats:true,Farm:true,Mine:true,Factory:true,Bank:true,Temple:true,'Wizard tower':true,Shipment:true,'Alchemy lab':true,Portal:true,'Time machine':true,'Antimatter condenser':true,Prism:true,Chancemaker:true};
