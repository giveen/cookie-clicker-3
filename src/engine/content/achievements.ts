...
export function declareVanillaAchievements(Game: EngineGame) {
		...
		/* --- Section 6: the Heavenly Pantry (CC3) ---------------------------- */
		/* A ladder of Pantry-completion achievements. Icons come from the
		 * food atlas (public/img/foodIcons.png, generated by
		 * scripts/extract-food-icons.mjs — dotoridev's "Free - 500+ Pixel
		 * Food Icons" pack, CC BY 4.0). */
		new Game.Achievement('Snack break',loc("Own <b>%1 Heavenly Pantry upgrades</b>.",5)+'<q>It is not stealing if it is your own pantry. Probably.</q>',[6,1,'img/foodIcons.png',48]);
		new Game.Achievement('Pantry raider',loc("Own <b>%1 Heavenly Pantry upgrades</b>.",10)+'<q>The shelves moan when you walk past. You take that as encouragement.</q>',[7,1,'img/foodIcons.png',48]);
		new Game.Achievement('Keeper of the Eternal Feast',loc("Own <b>every Heavenly Pantry upgrade</b>.<div class=\"line\"></div>Keystone perk: cookie production <b>+1%</b>."),[8,1,'img/foodIcons.png',48]);
